        ...
        <div class="page-title-inner">
            ...
            <div class="container">
                <div class="page-title-text">
                    <h1 class="title">{{$content->content(6, 66)}}</h1>
                    <div class="subtitle">{{$content->content(6, 67)}}</div></div>
...
@section('content1')
            ...
            <div class="wpb_wrapper">
                ...
                <div class="cms-heading-container vc_custom_1457345350984">
                    <div class="cms-heading text-left">
                        <div class="heading-block">
                            <h2 class="title"><span class="title-shadow">{{$content->content(6, 68)}}</span><span class="title-text">{{$content->content(6, 68)}}</span></h2>
                            <h6 class="subtitle">{{$content->content(6, 69)}}</h6><span class="cms-divider divider-horizontal"><span class="divider-line-1">-</span><span class="divider-line-2">-</span><span class="divider-line-3">-</span></span>
                        </div>
                    </div>
                </div>
                <div class="vc_row wpb_row vc_inner vc_row-fluid">
                            ...
                            <div class="wpb_wrapper">
                                <div class="wpb_text_column wpb_content_element font-xlarge font-alt-3">
                                    <div class="wpb_wrapper font-alt-3">
                                        <p><em>{{$content->content(6, 70)}}</em></p>
                                    </div>
                                </div>
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-6">
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                                <div class="cms-counters-wrapper cms-counters-with-sep vc_custom_1457345409835">
                                    <div class="cms-inline-block-wrapper cms-counters">
                                        <div class="counter-item cms-inline-block-xs-12 cms-inline-block-sm-4 cms-inline-block-md-4 cms-inline-block-lg-4"><div class="cms-counter-wrapper">
                ...
                <div class="wpb_wrapper">
                    ...
                    <div class="cms-heading-container cms-heading-with-desc-custom">
                        <div class="cms-heading cms-heading-with-desc">
                            <div class="heading-block">
                                <h2 class="title" style="color:#ffffff">{{$content->content(6, 71)}}</h2><span class="cms-heading-divider" style="border-color:rgba(255,255,255,0.07)"></span>
                            </div>
                            <div class="desc-block">
                                {{$content->content(6, 72)}}
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title">{{$content->content(6, 73)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(6, 74)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title"> {{$content->content(6, 75)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(6, 76)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title"> {{$content->content(6, 77)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(6, 78)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    {{--<div class="cms-heading-container"><div class="cms-heading text-center"><div class="heading-block"><h6 class="subtitle"> {{$content->content(6, 79)}}</h6>--}}
                {{--<h2 class="title">--}}
                    {{--<span class="title-text"> {{$content->content(6, 80)}}</span>--}}
                {{--</h2><span class="cms-divider divider-horizontal">--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title"> {{$content->content(6, 81)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(6, 82)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(6, 83)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(6, 84)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(6, 85)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(6, 86)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(6, 87)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(6, 88)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(6, 89)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(6, 90)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(6, 91)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(6, 92)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
