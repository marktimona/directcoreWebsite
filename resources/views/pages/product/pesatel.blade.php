        ...
        <div class="page-title-inner">
            ...
            <div class="container">
                <div class="page-title-text">
                    <h1 class="title">{{$content->content(8, 120)}}</h1>
                    <div class="subtitle">{{$content->content(8, 121)}}</div></div>
...
@section('content1')
                ...
                <div class="cms-heading-container vc_custom_1457345350984">
                    <div class="cms-heading text-left">
                        <div class="heading-block">
                            <h2 class="title"><span class="title-shadow">{{$content->content(8, 122)}}</span><span class="title-text">{{$content->content(8, 122)}}</span></h2>
                            <h6 class="subtitle">{{$content->content(8, 123)}}</h6><span class="cms-divider divider-horizontal"><span class="divider-line-1">-</span><span class="divider-line-2">-</span><span class="divider-line-3">-</span></span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="wpb_wrapper">
                                <div class="wpb_text_column wpb_content_element font-xlarge font-alt-3">
                                    <div class="wpb_wrapper font-alt-3">
                                        <p><em>{{$content->content(8, 124)}}</em></p>
                                    </div>
                                </div>
                ...
                <div class="wpb_wrapper">
                    ...
                    <div class="cms-heading-container cms-heading-with-desc-custom">
                        <div class="cms-heading cms-heading-with-desc">
                            <div class="heading-block">
                                <h2 class="title" style="color:#ffffff">{{$content->content(8, 125)}}</h2><span class="cms-heading-divider" style="border-color:rgba(255,255,255,0.07)"></span>
                            </div>
                            <div class="desc-block">
                                {{$content->content(8, 126)}}.
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title">{{$content->content(8, 127)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(8, 128)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title">{{$content->content(8, 129)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(8, 130)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title">{{$content->content(8, 131)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(8, 132)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    {{--<div class="cms-heading-container">--}}
        {{--<div class="cms-heading text-center">--}}
            {{--<div class="heading-block">--}}
                {{--<h6 class="subtitle">{{$content->content(8, 133)}}</h6>--}}
                {{--<h2 class="title">--}}
                    {{--<span class="title-text">{{$content->content(8, 134)}}</span></h2>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(8, 135)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(8, 136)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(8, 137)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(8, 138)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(8, 139)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(8, 140)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(8, 141)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(8, 142)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(8, 143)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(8, 144)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(8, 145)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(8, 146)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
