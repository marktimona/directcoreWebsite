        ...
        <div class="page-title-inner">
            ...
            <div class="container">
                <div class="page-title-text">
                    <h1 class="title">{{$content->content(7, 93)}}</h1>
                    <div class="subtitle">{{$content->content(7, 94)}}</div></div>
...
@section('content1')
                ...
                <div class="cms-heading-container vc_custom_1457345350984">
                    <div class="cms-heading text-left">
                        <div class="heading-block">
                            <h2 class="title"><span class="title-shadow">{{$content->content(7, 95)}}</span><span class="title-text">{{$content->content(7, 95)}}</span></h2>
                            <h6 class="subtitle">{{$content->content(7, 96)}}</h6><span class="cms-divider divider-horizontal"><span class="divider-line-1">-</span><span class="divider-line-2">-</span><span class="divider-line-3">-</span></span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="wpb_wrapper">
                                <div class="wpb_text_column wpb_content_element font-xlarge font-alt-3">
                                    <div class="wpb_wrapper font-alt-3">
                                        <p><em>{{$content->content(7, 97)}}</em></p>
                                    </div>
                                </div>
                ...
                <div class="wpb_wrapper">
                    ...
                    <div class="cms-heading-container cms-heading-with-desc-custom">
                        <div class="cms-heading cms-heading-with-desc">
                            <div class="heading-block">
                                <h2 class="title" style="color:#ffffff">{{$content->content(7, 98)}}</h2><span class="cms-heading-divider" style="border-color:rgba(255,255,255,0.07)"></span>
                            </div>
                            <div class="desc-block">
                                {{$content->content(7, 99)}}
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="vc_column-inner">
                                <div class="wpb_wrapper">
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title">{{$content->content(7, 100)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(7, 101)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title">{{$content->content(7, 102)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(7, 103)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cms-fancybox cms-fancybox-default cms-fancybox-color-light">
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    ...
                                                    <h4 class="fancybox-title">{{$content->content(7, 104)}}</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    {{$content->content(7, 105)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="vc_empty_space" style="height: 18px">
                                        <span class="vc_empty_space_inner"></span>
                                    </div><button class="btn-primary btn-hover-white">Explore Features</button>
    ...
    {{--<div class="cms-heading-container">--}}
        {{--<div class="cms-heading text-center">--}}
            {{--<div class="heading-block">--}}
                {{--<h6 class="subtitle">{{$content->content(7, 106)}}</h6>--}}
                {{--<h2 class="title"><span class="title-text">{{$content->content(7, 107)}}</span></h2>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(7, 108)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(7, 109)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(7, 110)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(7, 111)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(7, 112)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(7, 113)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(7, 114)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(7, 115)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(7, 116)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(7, 117)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
                        ...
                        {{--<div class="cms-fancybox cms-fancybox-left-icon cms-fancybox-color-dark">--}}
                            {{--<div class="fancybox-body">--}}
                                {{--<div class="fancybox-header">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<h4 class="fancybox-title">{{$content->content(7, 118)}}</h4>--}}
                                {{--</div>--}}
                                {{--<div class="fancybox-content">--}}
                                    {{--{{$content->content(7, 119)}}--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            {{--<div class="fancybox-action">--}}
                                {{--<a class="fancybox-link link-underline" href="#" target="_self" title="Learn More">Learn More<i class="fa fa-long-arrow-right"></i></a>--}}
