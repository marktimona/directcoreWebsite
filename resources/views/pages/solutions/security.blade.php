                                        ...
                                        <div class="cms-fancybox cms-fancybox-top-left-icon cms-fancybox-color-custom">
                                            ...
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    <h4 class="fancybox-title">DATA
CENTER</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    Design; <br> Cabling;<br> Floor; <br>Cooling; <br>Fire Rating;<br> Access
Control; <br>Surveillance System;<br>
 Alarm System;
  <br>Power
                                                </div>
                                            </div>
                                ...
                                <div class="wpb_wrapper">
                                    <div class="cms-fancybox-wrapper">
                                        <div class="cms-fancybox cms-fancybox-top-left-icon cms-fancybox-color-custom">
                                            ...
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    <h4 class="fancybox-title">PHYSICAL
SECURITY</h4>
                                                </div>
                                                <div class="fancybox-content">
                                      Design; <br> CCTV Surveillance System;<br> Access Control
System; <br>Electronic Alarm System;<br> Electronic Asset<br>
Tagging             
                                           </div>
                                            </div>
                                            <div class="fancybox-action">
                                ...
                                <div class="wpb_wrapper">
                                    <div class="cms-fancybox-wrapper">
                                        <div class="cms-fancybox cms-fancybox-top-left-icon cms-fancybox-color-custom">
                                            ...
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    <h4 class="fancybox-title">STORAGE</h4>
                                                </div>
                                                <div class="fancybox-content">
Design;<br> Storage Area Networks;<br> Network Attached
Storage;<br> Backups;<br> Digitization; <br> Archiving
                                                </div>
                                            </div>
                                            <div class="fancybox-action">
                                ...
                                <div class="wpb_wrapper">
                                    <div class="cms-fancybox-wrapper">
                                        <div class="cms-fancybox cms-fancybox-top-left-icon cms-fancybox-color-custom">
                                            ...
                                            <div class="fancybox-body">
                                                <div class="fancybox-header">
                                                    <h4 class="fancybox-title">UNIFIED
COMM</h4>
                                                </div>
                                                <div class="fancybox-content">
                                                    Design; <br> Contact Center; <br>Call Center;<br> IVR; <br>IP
Telephony;<br> Teleconference; <br>Video Conference
